...
const INTERNSHIP = [
  {
    ...
    tag: "最大6ヶ所",
    title: "在学中に最大6つの現場を経験",
    text: "全国の提携施設から、在学中に最大6ヶ所で実習・インターン研修を経験できます。さまざまな職場で実践を重ね、自分に合った仕事を見つけながら、卒業後に活躍できる力を身につけます。",
  },
  {
    image: "/images/uploads/g2.jpg",
    tag: "月あたり約10万円",
    title: "働きながら学ぶ、報酬型インターン",
    text: "本校独自の制度により、実習期間中は1ヶ月あたり約10万円の報酬を受け取ることができます。「学ぶ」と「働く」を同時に経験しながら、技術と社会人としての力を養います。",
  },
  {
    image: "/images/uploads/g3.jpg",
    tag: "トップレベルの牧場",
    title: "トップレベルの牧場で本物を学べる",
    text: "実習先には、社台グループをはじめとするチャンピオンズファーム・グリーンウッドパークなど、競走馬業界を代表する育成牧場も。学生のうちから第一線の現場に入り、本物の仕事を経験します。",
  },
] as const;
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <SectionTitle
            ...
            title={
              <>
                実習・インターン研修
                <span className="mt-3 block text-[1.25rem] font-bold tracking-[0.04em] md:text-2xl">
                  学校で学び、現場で確かめる。
                </span>
              </>
            }
            lead="就職前にどれだけ多くの「本物の現場」を経験できるか。それが、夢を仕事にするための大きな力になります。本校では業界とのネットワークを活かし、在学中から全国の競走馬育成牧場や乗馬クラブなどで実践経験を積みます。"
          />
