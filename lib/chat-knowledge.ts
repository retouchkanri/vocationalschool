...
export const CHAT_KNOWLEDGE: KnowledgeEntry[] = [
  {
    ...
    answer: `${SCHOOL.name}（${SCHOOL.nameShort}）は、${SCHOOL.operator}が運営する馬の専門学校です。所在地は${SCHOOL.zip} ${SCHOOL.address}。約${STATS[0].value}頭の馬と国内最大級${STATS[1].value}つの教育施設で、未経験からJRA厩務員・牧場・乗馬クラブへの就職を目指せます。お電話は ${SCHOOL.tel} です。`,
    relatedHref: "/about",
  },
  {
    id: "contact-inquiry",
  ...
  },
  {
    ...
    answer:
      "本校の特長は、約120頭の馬とともに現場で学べること、千葉・大阪など国内最大級4つの教育拠点、未経験者向けの段階的カリキュラム、JRA厩務員課程への高い合格実績、そして先生と生徒の距離が近い雰囲気です。他校比較のために見学された方の多くが出願を検討されています。",
  ...
  },
  {
    ...
    answer:
      "令和9年4月生の出願期間は令和8年5月1日（金）〜7月24日（金）です。インターネットの入学出願フォームからお申し込みいただき、先着順で随時選考します。定員になり次第終了するため、お早めの出願をおすすめします。合格内定後に入校申込書・健康診断書・住民票（発行3ヶ月以内・家族構成がわかるもの）をご提出いただきます。",
  ...
  },
  {
    ...
    answer:
      "技術レベルや経験により本校が認めた場合、在学中に最大2回、JRA競馬学校厩務員課程を受験できます。在学中・卒業生から多数の合格者を輩出しており、在学中合格時は奨励金10万円を諸経費の還付として支給します。JRA厩務員課程は10年連続の合格実績もあります。",
    relatedHref: "/jra",
  },
  {
    id: "careers",
    ...
    answer:
      "卒業後の進路は、JRA厩務員、競走馬の生産・育成牧場、乗馬クラブ、観光牧場、養老牧場などです。基本的にほぼ全員が在学中に就職内定を得ており、万が一決まらない場合も追加授業費なく就職決定までサポートします。令和7年度は牧場・乗馬クラブ就職率100%です。",
    relatedHref: "/jra",
  },
  {
    id: "beginner",
